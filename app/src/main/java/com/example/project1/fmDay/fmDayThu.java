...
import com.example.project1.adapterDay.adt_rv_dayth;
 ...
 * {@link fmDayThu.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link fmDayThu#newInstance} factory method to
 * create an instance of this fragment.
 */
public class fmDayThu extends Fragment {
     ...
     * @return A new instance of fragment fmDayThu.
     */
    // TODO: Rename and change types and number of parameters
    public static fmDayThu newInstance(String param1, String param2) {
        fmDayThu fragment = new fmDayThu();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //return inflater.inflate(R.layout.fragment_fm_day_thu, container, false);
        ...
        final RecyclerView.Adapter adapter = new adt_rv_dayth();
        ...
        for(int i=0; i <DAYLEC_1.size(); i++){
            ...
            if(DAYLEC_1.get(i).equals("06")  || DAYLEC_1.get(i).equals("11") || DAYLEC_1.get(i).equals("34") || DAYLEC_1.get(i).equals("10") || DAYLEC_1.get(i).equals("25")){
            ...
            if(DAYLEC_2.get(i) != null) {
                ...
                if (DAYLEC_2.get(i).equals("06") || DAYLEC_2.get(i).equals("11") || DAYLEC_2.get(i).equals("34") || DAYLEC_2.get(i).equals("10") || DAYLEC_2.get(i).equals("25")) {
                    CourseTitleListNew.add(CourseTitleList.get(i));
                    CourseNoListNew.add(CourseNoList.get(i));
                    BTLEC_1New.add(BTLEC_1.get(i));
                    FTLEC_1New.add(FTLEC_1.get(i));
        ...
        ((adt_rv_dayth) adapter).set_adt_rv_cir(CourseTitleListNew,CourseNoListNew,BTLEC_1New,FTLEC_1New,ROOMNew);
