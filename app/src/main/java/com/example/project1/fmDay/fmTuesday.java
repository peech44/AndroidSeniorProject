...
import com.example.project1.adapterDay.adt_rv_daytue;
 ...
 * {@link fmTuesday.OnFragmentInteractionListener} interface
 * to handle interaction events.
 * Use the {@link fmTuesday#newInstance} factory method to
 * create an instance of this fragment.
 */
public class fmTuesday extends Fragment {
     ...
     * @return A new instance of fragment fmTuesday.
     */
    // TODO: Rename and change types and number of parameters
    public static fmTuesday newInstance(String param1, String param2) {
        fmTuesday fragment = new fmTuesday();
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //return inflater.inflate(R.layout.fragment_fm_tuesday, container, false);
        ...
        final RecyclerView.Adapter adapter = new adt_rv_daytue();
        ...
        for(int i=0; i <DAYLEC_1.size(); i++){
            ...
            if(DAYLEC_1.get(i).equals("04")  || DAYLEC_1.get(i).equals("11") || DAYLEC_1.get(i).equals("30") || DAYLEC_1.get(i).equals("10")|| DAYLEC_1.get(i).equals("25")){
            ...
            if(DAYLEC_2.get(i) != null) {
                ...
                if (DAYLEC_2.get(i).equals("04") || DAYLEC_2.get(i).equals("11") || DAYLEC_2.get(i).equals("30") || DAYLEC_2.get(i).equals("10") || DAYLEC_2.get(i).equals("25")) {
                    CourseTitleListNew.add(CourseTitleList.get(i));
                    CourseNoListNew.add(CourseNoList.get(i));
                    BTLEC_1New.add(BTLEC_1.get(i));
                    FTLEC_1New.add(FTLEC_1.get(i));
        ...
        ((adt_rv_daytue) adapter).set_adt_rv_cir(CourseTitleListNew,CourseNoListNew,BTLEC_1New,FTLEC_1New,ROOMNew);
