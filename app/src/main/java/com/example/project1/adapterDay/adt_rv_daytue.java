...
public class adt_rv_daytue extends RecyclerView.Adapter<adt_rv_daytue.ViewHolder> {
    ...
    @Override
    public adt_rv_daytue.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i){
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.rv_daytue, viewGroup, false);

        adt_rv_daytue.ViewHolder viewHolder = new adt_rv_daytue.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(adt_rv_daytue.ViewHolder viewHolder, int i){
/*
        if((i+1)%2==0){
