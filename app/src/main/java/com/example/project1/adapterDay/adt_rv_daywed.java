...
public class adt_rv_daywed extends RecyclerView.Adapter<adt_rv_daywed.ViewHolder> {
    ...
    @Override
    public adt_rv_daywed.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i){
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.rv_daywed, viewGroup, false);

        adt_rv_daywed.ViewHolder viewHolder = new adt_rv_daywed.ViewHolder(v);
        return viewHolder;
    }
