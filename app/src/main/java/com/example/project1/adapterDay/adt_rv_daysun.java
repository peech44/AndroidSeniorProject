...
public class adt_rv_daysun extends RecyclerView.Adapter<adt_rv_daysun.ViewHolder> {
    ...
    @Override
    public adt_rv_daysun.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i){
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.rv_daysun, viewGroup, false);

        adt_rv_daysun.ViewHolder viewHolder = new adt_rv_daysun.ViewHolder(v);
        return viewHolder;
    }
