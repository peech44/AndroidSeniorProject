...
public class adt_rv_dayth extends RecyclerView.Adapter<adt_rv_dayth.ViewHolder> {
    ...
    @Override
    public adt_rv_dayth.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i){
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.rv_daythu, viewGroup, false);

        adt_rv_dayth.ViewHolder viewHolder = new adt_rv_dayth.ViewHolder(v);
        return viewHolder;
    }
