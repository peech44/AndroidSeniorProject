...
public class adt_rv_daymon extends RecyclerView.Adapter<adt_rv_daymon.ViewHolder> {
    ...
    @Override
    public adt_rv_daymon.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i){
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.rv_daymon, viewGroup, false);

        adt_rv_daymon.ViewHolder viewHolder = new adt_rv_daymon.ViewHolder(v);
        return viewHolder;
    }
