...
public class adt_rv_daysat extends RecyclerView.Adapter<adt_rv_daysat.ViewHolder> {
    ...
    @Override
    public adt_rv_daysat.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i){
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.rv_daysat, viewGroup, false);

        adt_rv_daysat.ViewHolder viewHolder = new adt_rv_daysat.ViewHolder(v);
        return viewHolder;
    }
